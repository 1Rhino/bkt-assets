...
function upload()
  ...
  document.getElementById("idUploadStatus").innerHTML=getTxt("Uploading..-2E")
...
function selectFile(index)
  ...
  if(bReturnAbsolute)
    {
    sFile_RelativePath = window.location.protocol + "../../../../../index.htm" + window.location.host.replace(/:80/,"") + sFile_RelativePath
    //Ini input dr yg pernah pake port:
    //sFile_RelativePath = window.location.protocol + "../../../../../index.htm" + window.location.host.replace(/:80/,"") + "/" + sFile_RelativePath.replace(/\.\.\//g,"")
    }
...
<b>Warning</b>:  opendir(c:/inetpub/wwwroot/Editor/assets) [<a HREF="function.opendir">function.opendir</a>]: failed to open dir: No such file or directory in <b>/home/peacepilot/public_html/includes/editor/assetmanager/assetmanager.php</b> on line <b>139</b><br />
<br />
<b>Warning</b>:  readdir(): supplied argument is not a valid Directory resource in <b>/home/peacepilot/public_html/includes/editor/assetmanager/assetmanager.php</b> on line <b>140</b><br />
<br />
<b>Warning</b>:  closedir(): supplied argument is not a valid Directory resource in <b>/home/peacepilot/public_html/includes/editor/assetmanager/assetmanager.php</b> on line <b>167</b><br />
</select>&nbsp;</td>
        <td nowrap>
...
<b>Warning</b>:  opendir(c:/inetpub/wwwroot/Editor/assets) [<a HREF="function.opendir">function.opendir</a>]: failed to open dir: No such file or directory in <b>/home/peacepilot/public_html/includes/editor/assetmanager/assetmanager.php</b> on line <b>205</b><br />
<br />
<b>Warning</b>:  readdir(): supplied argument is not a valid Directory resource in <b>/home/peacepilot/public_html/includes/editor/assetmanager/assetmanager.php</b> on line <b>206</b><br />
<br />
<b>Warning</b>:  sort() expects parameter 1 to be array, null given in <b>/home/peacepilot/public_html/includes/editor/assetmanager/assetmanager.php</b> on line <b>210</b><br />
<tr><td colspan=4 height=100% align=center><script>document.write(getTxt('Empty..-2E'))</script></td></tr></table></div><input type=hidden name=inpUploadedFile id=inpUploadedFile value=''><input type=hidden name=inpNumOfFiles id=inpNumOfFiles value='0'><br />
<b>Warning</b>:  closedir(): supplied argument is not a valid Directory resource in <b>/home/peacepilot/public_html/includes/editor/assetmanager/assetmanager.php</b> on line <b>342</b><br />
        </td>
        </tr>
        </table>
