...
function writeFileSelections()
  ...
  for each oFile in oFiles
    ...
    if bDisplay then
      ...
      Response.Write "<tr style='background:" & sColorResult & "'>" & VbCrLf & _
        "<td><img SRC="images/-22&sIcon&-22"></td>" & VbCrLf & _
  ...
  if bFileFound=false then
    Response.Write "<tr><td colspan=4 height=100% align=center><script>document.write(getTxt('Empty..-2E'))</script></td></tr></table></div>"
  else
