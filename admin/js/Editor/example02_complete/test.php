...
<form method="post" action="default_toolbar.php" id="Form1">
  ...
  <script>
    ...
    oEdit1.width=725;
    oEdit1.height=450;
    oEdit1.arrCustomButtons = [["CustomName1","alert('Command-25201-2520here.')","Caption 1 here","btnCustom1.gif"],
	...
	"XHTMLFullSource","XHTMLSource", "CustomObject",
    "JustifyLeft","JustifyCenter","JustifyRight","JustifyFull", "BRK",
