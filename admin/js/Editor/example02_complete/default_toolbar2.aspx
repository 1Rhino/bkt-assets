...
<head>
    ...
    <script language="VB" runat="server">
        Sub Page_Load(Source As Object, E As EventArgs)
            ...
            oEdit1.ToolbarCustomButtons.add(New CustomButton("CustomName1", "alert('Command-25201-2520here.')", "Caption 1 here", "btnCustom1.gif"))
            oEdit1.ToolbarCustomButtons.add(New CustomButton("CustomName2", "alert('Command-25202-2520here.')", "Caption 2 here", "btnCustom2.gif"))
            oEdit1.ToolbarCustomButtons.add(New CustomButton("CustomName3", "alert('Command-25203-2520here.')", "Caption 3 here", "btnCustom3.gif"))
